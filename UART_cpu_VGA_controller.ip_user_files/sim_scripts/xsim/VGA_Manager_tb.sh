...
#
# Script generated by Vivado on Mon Sep 14 13:40:28 +0300 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : VGA_Manager_tb.sh
...
#
# Usage        : VGA_Manager_tb.sh
#                VGA_Manager_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                VGA_Manager_tb.sh [-reset_run]
#                VGA_Manager_tb.sh [-reset_log]
#                VGA_Manager_tb.sh [-help]
#
...
# script info
echo -e "VGA_Manager_tb.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./VGA_Manager_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot VGA_Manager_tb xil_defaultlib.VGA_Manager_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim VGA_Manager_tb -key {Behavioral:sim_1:Functional:VGA_Manager_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb VGA_Manager_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./VGA_Manager_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: VGA_Manager_tb.sh [-help]\n\
Usage: VGA_Manager_tb.sh [-step]\n\
Usage: VGA_Manager_tb.sh [-lib_map_path]\n\
Usage: VGA_Manager_tb.sh [-reset_run]\n\
Usage: VGA_Manager_tb.sh [-reset_log]\n\
Usage: VGA_Manager_tb.sh [-keep_index]\n\
Usage: VGA_Manager_tb.sh [-noclean_files]\n\n\
