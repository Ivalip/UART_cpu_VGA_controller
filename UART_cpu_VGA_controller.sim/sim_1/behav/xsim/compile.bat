...
REM
REM Generated by Vivado on Sun Sep 13 21:55:39 +0300 2026
...
echo "xvlog --incr --relax -prj VGA_Manager_tb_vlog.prj"
call xvlog  --incr --relax -prj VGA_Manager_tb_vlog.prj -log xvlog.log
