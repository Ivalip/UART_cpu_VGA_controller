...
REM
REM Generated by Vivado on Sun Sep 20 12:15:37 +0300 2026
...
echo "xvlog --incr --relax -prj tb_handler_cpu_vlog.prj"
call xvlog  --incr --relax -prj tb_handler_cpu_vlog.prj -log xvlog.log
